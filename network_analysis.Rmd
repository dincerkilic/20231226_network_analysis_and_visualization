...
Furthermore, the diameter of the network appeared to be 10. This can be explained with a small-world effect in PPINs meaning that there is great connectivity between proteins. In other words, the network’s diameter (the maximum number of steps separating any two nodes) is small, no matter how big the network is.
