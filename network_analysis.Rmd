...
Betweenness centrality captures which nodes are important in the flow of the network. It makes use of the shortest paths in the network. Betweenness effectively counts how many shortest paths each node is on. This is divided by the total number of shortest paths.
