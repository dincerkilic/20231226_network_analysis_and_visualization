...
Furthermore, the diameter of the network appeared to be 10. This can be explained with a small-world effect in PPINs, meaning there is great connectivity between proteins. In other words, the network’s diameter is small, no matter how big the network is.
