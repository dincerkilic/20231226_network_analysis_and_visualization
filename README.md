...
as sample_gnp(), sample_gnm functions, make_graph(),
graph_from_literal().
...
```
    ...
    ## [1] "Loaded network 'STRING network - TP53 - 31' with 201 nodes and 1238 edges"
...
```
    ...
    ## + 1/201 vertex, named, from 7bfa362:
...
yellow](/home/dinc/Documents/MAASTRICHT/c_random_network_with_200_nodes.png)
